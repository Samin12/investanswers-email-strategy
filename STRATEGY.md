...
> **Live override — August 7, 2026:** The newest Weekly Edge is `LEVELS/THESIS`, not a fresh trade alert, but it is the latest James guidance. BTC is now explicitly in a **buying zone**, with **$67K and $70K** as resistance ceilings and about **$50K** still the massive-buy level. MRVL should not be bought above $200; wait for a dip **under $200 plus a buy signal**. After SPCX's roughly 30% week, James remains only 3/20 loaded and says he will be patient with no FOMO/POMO. PLTR is around his $171 covered-call breakeven, but mean reversion remains the management plan. The newest approved-universe `TRADE_ALERT` remains the August 4 PLTR hedge, already mirrored at account scale with a risk-reducing share trim because the paper account lacked 100-share call coverage. Keep new AI adds blocked while theme and single-name concentrations exceed caps. Sources: `2026-08-07_211556_Weekly-Edge-Aug-7-Monster-Recovery-Week`, `2026-08-06_174033_IA-Weekly-Nuggets-July-29-Aug-5-2026`, and `2026-08-04_134008_IA-Trade-Alert`.
